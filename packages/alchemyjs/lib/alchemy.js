...
var API, Clustering, DrawEdge, DrawEdges, DrawNode, DrawNodes, Editor, EditorInteractions, EditorUtils, Layout, Remove, root, warnings,
  __slice = [].slice,
...
alchemy = {
  begin: function(config) {
    return alchemy = new Alchemy(config);
  }
};
